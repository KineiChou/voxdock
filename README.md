...
**Source alpha.** Protocol adapters and local tests exist; real phone calls and paid Live sessions have not been validated. Start with the paused local service. WhatsApp integration is experimental and is not yet an available end-to-end runtime route.
...
| WhatsApp | WaCalls control, authenticated Go PCM patch and Node media client | Go builds, loopback PCM and fixture tests; full runtime experimental |
| Packaging | Source install and local Docker/Compose definitions | Docker runtime and Linux native loading require validation |
