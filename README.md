...
- A mobile-friendly operator console: call trends, Live budget, filterable audit records, QR account linking, verified receiving numbers, managed settings and explicit maintenance controls. Configured calling remains available automatically.
...
| Operator console | Username/password login, dashboard, audits, managed configuration, Telegram/WhatsApp pairing and CLI parity | Single operator; WhatsApp QR/message/call setup requires handset acceptance |
