...
| Source distribution and operator-local builds | Native account/media and Linux deployment evidence is incomplete. Original-code MIT licensing is distinct from native dependency redistribution. |
